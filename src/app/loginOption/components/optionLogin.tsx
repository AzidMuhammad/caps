      ...
      <div className="flex items-center justify-center py-12">
        <div className="mx-auto grid w-[350px] gap-6">
          ...
          <div className="grid -mt-10">
            ...
            onClick={() => router.push('/loginWorker')}
            >
            ...
            <div className="grid gap-3">
            <button 
            className="mt-4 bg-gradient-to-br relative group/btn from-neutral-100 to-neutral-200 block w-full text-[#3676e0] rounded-xl h-10 font-medium shadow-[0px_1px_0px_0px_var(--zinc-800)_inset,0px_-1px_0px_0px_var(--zinc-800)_inset]"
            onClick={() => router.push('/loginCustomer')}
            >
            ...
            <div className="bg-gradient-to-r from-transparent via-neutral-200 to-transparent my-8 h-[1px] w-full" />
                <p className="text-neutral-200 text-sm text-center">Don`t have an account? <a className="text-white hover:underline ml-1 whitespace-nowrap font-semibold cursor-pointer" onClick={() => router.push('/registerOption')}>Register here</a></p>
          </div>
        </div>
      </div>
