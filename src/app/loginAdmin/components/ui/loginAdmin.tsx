...
export default function LoginFormAdmin() {
  ...
  return (
    <div className="w-full lg:grid bg-[#3676e0] lg:min-h-[600px] xl:min-h-[729px] min-h-screen">
        ...
        <div className="mx-auto grid w-[350px] gap-6">
          ...
          <div className="grid gap-7 -mt-14">
            <form onSubmit={handleSubmit}>
              ...
              <button
                className="mt-6 mb-10 bg-gradient-to-br relative group/btn from-neutral-100 to-neutral-200 block w-full text-[#3676e0] rounded-xl h-10 font-medium shadow-[0px_1px_0px_0px_var(--zinc-800)_inset,0px_-1px_0px_0px_var(--zinc-800)_inset]"
                type="submit"
              >
                Log In &rarr;
                <BottomGradient />
      ...
      <div className="hidden bg-muted lg:block -mt-28">
        <Image
